...
public class AbstractPage<T extends AbstractPage<T>> {
    ...
    public T validating_Successfull_Login(String title) {
        {
            try {
                Thread.sleep(8000);
            ...
            if (this.driver.getTitle().contains(title)) {
    ...
    public T orderingOfElementByDecendingOrderOrReverseOrder(By locator) {
        List<WebElement> products_Webelement = new LinkedList<WebElement>();
        products_Webelement = find_elements(locator);
        LinkedList<String> product_names = new LinkedList<String>();
        for (int i = 0; i < products_Webelement.size(); i++) {
            ...
            String s = webElement.getText();
            product_names.add(s);
            boolean result = chkReverseOrder(product_names);
    ...
    public static boolean chkReverseOrder(LinkedList<String> product_names) {
        Collections.sort(product_names, Collections.reverseOrder());
        return true;
    }
    ...
    public List<WebElement> find_elements(By locator) {
